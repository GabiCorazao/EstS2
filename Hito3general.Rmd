...
```
RESPUESTA: cor=0.5116449 

#PASO 2: Correlacion entre  "DesigualdadGenero"y "Violencia"
```{r}
#Analisis visual usando un grafico de dispersion
